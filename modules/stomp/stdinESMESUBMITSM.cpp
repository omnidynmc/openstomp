...
/**************************************************************************
 ** stdinESMESUBMITSM Class                                              **
 **************************************************************************/

  const int stdinESMESUBMITSM::Execute(COMMAND_ARGUMENTS) {
    ...
    ThreadMessage *tm = new ThreadMessage("submit_sm", "test");
